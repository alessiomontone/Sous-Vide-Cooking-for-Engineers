...
# Set the page title
st.set_page_config(page_title="Sous Vide Simulator", layout="wide")
...
def heating_page():
    ...
    st.sidebar.header("♨️ Cooking Simulation")
...
def cooling_page():
    st.title("Cooling Simulation")
    st.write("Work in progress...")


def parameters_page():
    st.title("Parameters Calculation")
    st.write("Work in progress...")

pages = [
    st.Page(heating_page, title="♨️ Cooking Simulation"),
    st.Page(cooling_page, title="❄️ Cooling Simulation"),
    st.Page(parameters_page, title="⚙️ Parameters Calculation")
]
